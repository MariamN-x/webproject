...
const admins = [
    { id: 1, email: 'Admin1@hotmail.com', password: 'Admin777' }, // 'password1' hashed
    { id: 2, email: 'Admin2@hotmail.com', password: 'Admin888' }  // 'password2' hashed
];
...
app.post('/login', async (req, res) => {
    ...
    try {
        ...
        req.session.userId = admin.id; // Use admin.id since it is not a mongoose model
